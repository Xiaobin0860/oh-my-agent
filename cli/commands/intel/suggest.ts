...
import { collectGitHubSignals } from "./collect-github.js";
import {
  collectLocalSignals,
  collectMarketSignals,
  loadFixture,
} from "./collect-local.js";
import { resolveIntelConfig } from "./config.js";
import { createGitHubIssue } from "./github-issue.js";
import { renderGapReport, renderPrd, reportDate } from "./render.js";
import { reviewCandidates, scoreCandidates } from "./scoring.js";
import type { IntelRunOptions, IntelRunResult, RenderInput } from "./types.js";

export { resolveIntelConfig } from "./config.js";
export { reviewCandidates, scoreCandidates } from "./scoring.js";
export type {
  CandidateGap,
  IntelConfig,
  IntelRunOptions,

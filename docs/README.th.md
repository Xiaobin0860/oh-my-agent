...
|------|---------|-------------|
| 0 | `/deepinit` | บูตสแตรปโค้ดเบสที่มีอยู่ (AGENTS.md, ARCHITECTURE.md, `docs/`) |
...
| 3 | `/ralph` | ห่อ `/ultrawork` ด้วยลูปตรวจสอบอิสระจนกว่าจะผ่านเกณฑ์ |
...
| 5 | `/docs` | ตรวจสอบและซิงก์ความคลาดเคลื่อนของเอกสาร |

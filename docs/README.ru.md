...
|-----|---------|-------------|
| 0 | `/deepinit` | Инициализирует существующую кодовую базу (AGENTS.md, ARCHITECTURE.md, `docs/`) |
...
| 3 | `/ralph` | Оборачивает `/ultrawork` в независимый цикл проверки до прохождения всех критериев |
...
| 5 | `/docs` | Проверка и синхронизация дрейфа документации |
